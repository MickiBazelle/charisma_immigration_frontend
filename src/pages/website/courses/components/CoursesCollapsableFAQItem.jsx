...
function CoursesCollapsableFAQItem({ question, answer, addBorder = true }) {
  ...
  return (
    <div
      onClick={toogle}
      className={`flex flex-col max-w-full mb-10 text-lg font-medium leading-7 cursor-pointer  ${
        addBorder &&
        "border-t border-solid border-b-[color:var(--Colors-Border-border-secondary,#1F242F)]"
      }  text-neutral-100 w-[768px]`}
    >
      ...
      >
        <div
          className="mt-2 font-inter font-normal text-sm leading-6 text-slate-600 max-md:max-w-full"
...
export default CoursesCollapsableFAQItem;
