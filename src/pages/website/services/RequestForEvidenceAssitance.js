...
function TurningChallengesIntoOpportunities() {
  return (
        ...
        <ul className="flex flex-col pl-4 mt-8 text-lg leading-7 text-riverBed max-md:max-w-full">
          <li className="flex gap-3 max-md:flex-wrap">
            ...
            <p className="max-md:max-w-full pb-4 text-riverBed text-base font-inter">
              We help clients respond to USCIS RFEs effectively
            </p>
          </li>
          <li className="flex gap-3  max-md:flex-wrap">
            <img
            ...
            <p className="max-md:max-w-full text-riverBed text-base font-inter">
              We aim to transform stressful experiences into positive outcomes.
            </p>
          </li>
        </ul>
      </div>
      ...
      <div className="flex flex-col self-stretch px-5 my-auto max-md:mt-10 max-md:max-w-full">
        ...
        <ul className="flex flex-col pl-4 mt-8 text-lg leading-7 text-slate-600 max-md:max-w-full">
          <li className="flex gap-3 max-md:flex-wrap">
            ...
            />
            <p className="max-md:max-w-full text-riverBed text-base font-inter">
              Clients are walked through detailed steps to address RFE concerns.
            </p>
          </li>
          <li className="flex gap-3 mt-4 max-md:flex-wrap">
            ...
            />
            <p className="max-md:max-w-full text-riverBed text-base font-inter">
              We identify areas of improvement in the initial petition.
            </p>
          </li>
        </ul>
      </div>
      ...
      <div className="flex flex-col self-stretch my-auto max-md:mt-10 max-md:max-w-full">
        ...
        <ul className="flex flex-col pl-4 mt-8 text-lg leading-7 max-md:max-w-full">
          <li className="flex gap-3 max-md:flex-wrap">
            ...
            />
            <p className="max-md:max-w-full text-riverBed text-base font-inter">
              Assistance provided to ensure responses are compelling and
              thorough.
            </p>
          </li>
          <li className="flex gap-3 mt-4 max-md:flex-wrap">
            ...
            />
            <p className="max-md:max-w-full text-riverBed text-base font-inter">
              Clients need to provide a copy of the RFE, detailed CV, and
              initial petition for assistance.
            </p>
          </li>
        </ul>
      </div>
...
function RequestForEvidenceAssistance() {
  return (
    <div className="">
      <div className="flex flex-col items-center bg-white">
        ...
        <main className="flex flex-col py-20 bg-white">
          <h1 className="self-center mt-4 text-3xl font-inter font-semibold tracking-wide leading-10 text-center text-gray-900 max-md:max-w-full">
            REQUEST FOR EVIDENCE (RFE) ASSISTANCE
          </h1>
          <p className="self-center text-base font-inter leading-8 text-center text-slate-600 w-[768px] max-md:max-w-full">
            Receiving an RFE from USCIS can be stressful, but receiving an
            "intent to deny"
            <br />
            notice is even more daunting. This service aims to turn such
            experiences into
            <br />
            positive outcomes by guiding clients through a thorough response
            process.
          </p>
...
export default RequestForEvidenceAssistance;
