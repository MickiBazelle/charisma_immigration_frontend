    ...
    <div ref={ref}>
      <div className="relative">
        <button
          ...
          } relative lg:w-[32rem] border border-gray-300 rounded-lg shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
          ...
          {open && (
            ...
            >
              <div className="sticky top-0 z-10 bg-white">
                <li className=" text-gray-900 cursor-default select-none relative py-4 px-3">
                  <input
                    type="search"
                    name="search"
                    autoComplete={"off"}
                    className="focus:ring-blue-500 pl-3 focus:border-blue-500 block w-full py-2 sm:text-sm border-gray-300 rounded-md"
